...
declare class ColorTransformUtils {
    ...
    static addTransform(type: any, matrix: Array<number>): void;
}
...
declare module mo {
     ...
     * @param target
     */
    function delayCall(delay: number, selector: (...args) => void, ctx?: any): number;
    /**
     * 清除延迟执行的函数
     * @param key
     */
...
declare module mo {
     ...
     */
    function ArrayRemoveObjectAtIndex(arr: Array<any>, index: number): void;
    /**
     * 删除某个对象
     * @function
     * @param {Array} arr Source Array
     ...
     */
    function ArrayRemoveObject(arr: Array<any>, delObj: any): void;
    /**
     * @function
     * @param {Array} arr Source Array
     * @param {Array} minusArr minus Array
     */
    function ArrayRemoveArray(arr: Array<any>, minusArr: Array<any>): void;
    /**
     * 获取对象在数据里的排序
     * @function
     * @param {Array} arr Source Array
     ...
     */
    function ArrayGetIndexOfValue(arr: Array<any>, value: any): number;
    /**
     * 推送到数组里
     * @function
     * @param {Array} arr
     * @param {*} addObj
     */
    function ArrayAppendObject(arr: Array<any>, addObj: any): void;
    /**
     * 在数组里插入对象
     * @function
     * @param {Array} arr
     ...
     * @return {Array}
     */
    function ArrayAppendObjectToIndex(arr: Array<any>, addObj: any, index: number): Array<any>;
    /**
     * 在某个位置插入多个对象
     * @function
     * @param {Array} arr
     ...
     * @return {Number} index of first occurence of value
     */
    function ArrayGetIndexOfObject(arr: Array<any>, findObj: any): number;
    /**
     * 数组是否包含一个对象
     * @function
     * @param {Array} arr
     ...
     * @return {Boolean}
     */
    function ArrayContainsObject(arr: Array<any>, findObj: any): boolean;
    /**
     * 过滤重复的对象
     * @function
     * @param {Array} arr
...
declare module mo {
    class Node extends egret.DisplayObjectContainer {
         ...
         */
        getChildren(): Array<egret.DisplayObject>;
        /**
         * 获取Widget的子节点数量
         * @returns {Number}
         */
...
declare module mo {
    class _UILoadingBarOption extends Option {
        ...
        lightWidget: mo.UIImage;
        innerLabel: mo.UIText;
        _initProp(): void;
        dtor(): void;
    }
}
...
declare module mo {
    class UILoadingBar extends UIWidget {
        ...
        getLightWidget(): mo.UIImage;
        getInnerLabel(): mo.UIText;
        /**
         *  停止动态进度条，直接设置最终进度值
         */
...
declare module mo {
    class UIListView extends UIScrollView {
         ...
         */
        pushBackCustomItem(item: mo.UIWidget): void;
        /**
         * Push back custom item into listview.
         * @param {mo.UIWidget} item
         * @param {Number} index
         */
        insertCustomItem(item: mo.UIWidget, index: number): void;
        /**
         ...
         * @returns {mo.UIWidget}
         */
        getItem(index: number): mo.UIWidget;
        /**
         ...
         * @returns {Number}
         */
        getIndex(item: mo.UIWidget): number;
        /**
...
declare module mo {
    class UIPageView extends UIPanel {
         ...
         */
        addWidgetToPage(widget: mo.UIWidget, pageIdx: number, forceCreate: boolean): void;
        /**
         * create page
         * @returns {mo.UIPanel}
         */
        createPage(): mo.UIPanel;
        /**
         * Push back a page to pageview.
         * @param {mo.UIPanel} page
         */
        addPage(page: mo.UIPanel): void;
        /**
         * Inert a page to pageview.
         * @param {mo.UIPanel} page
         * @param {Number} idx
         */
        insertPage(page: mo.UIPanel, idx: number): void;
        /**
...
declare module mo {
    class LinearVerticalCtrl extends WidgetCtrl {
         ...
         * @param target
         */
        init(container: mo.UIPanel, templateName?: any, target?: any): void;
...
declare module mo {
    class PageViewController extends mo.WidgetCtrl {
        static __className: string;
...
declare module mo {
    ...
    class SceneMgr extends Class {
        ...
        purge(): void;
        isInStack(scene: mo.Scene): boolean;
        clear(): void;
    }
    var sceneMgr: any;
}
...
declare module mo {
    ...
    class ReconnectWaitingNode extends mo.WaitingLayer {
        static __className: string;
        _str: any;
        init(): void;
    }
 ...
 */
declare module mo {
    class Armature extends mo.Node {
        static __className: string;
        ...
        getBoneConfig(boneName: string): Array<number>;
    }
}
declare module mo {
    class ArmatureFactory extends MultiIdBaseFactory {
        ...
        produce(...args: any[]): mo.Armature;
        produceDynamic(...args: any[]): mo.Armature;
