...
(function (mo) {
    var UIDataParser = (function (_super) {
        ...
        __egretProto__._parseWidgetData = function (data, uiKey) {
            ...
            switch (className) {
                case mo.UIText.__className: return this._parseUITextData(data, uiKey, new mo.UITextData());
                case mo.UITextAtlas.__className: return this._parseUTextAtlasData(data, uiKey, new mo.UITextAtlasData());
                case mo.UIInput.__className: return this._parseUIInputData(data, uiKey, new mo.UIInputData());
                case mo.UIImage.__className: return this._parseUIImageData(data, uiKey, new mo.UIImageData());
                case mo.UIButton.__className: return this._parseUIButtonData(data, uiKey, new mo.UIButtonData());
                case mo.UILoadingBar.__className: return this._parseUILoadingBarData(data, uiKey, new mo.UILoadingBarData());
                case mo.UIPanel.__className: return this._parseUIPanelData(data, uiKey, new mo.UIPanelData());
                case mo.UIScrollView.__className: return this._parseUIScrollViewData(data, uiKey, new mo.UIScrollViewData());
                case mo.UIListView.__className: return this._parseUIListViewData(data, uiKey, new mo.UIListViewData());
                case mo.UIPageView.__className: return this._parseUIPageViewData(data, uiKey, new mo.UIPageViewData());
            }
