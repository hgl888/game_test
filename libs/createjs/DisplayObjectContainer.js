    ...
    var DisplayObjectContainer = (function (_super) {
        ...
        DisplayObjectContainer.prototype._makeBitmapCache = function () {
            if (this._maskObj) {
                ...
                r.drawToTexture(this._maskObj, this._maskObj.getBounds());
                var h = new createjs.DisplayObjectContainer();
                h.addChild(this._container);
                ...
                this._maskTexture.drawToTexture(h);
                h.removeChild(bitmap);
                h.removeChild(this._container);
                this._texture_to_render = this._maskTexture;
                if (!this._maskBitmap) {
                    this._maskBitmap = new egret.Bitmap();
                }
                this._maskBitmap.texture = this._maskTexture;
                _super.prototype.addChild.call(this, this._maskBitmap);
                r.dispose();
            }
            else {
                this.cleanMask();
        ...
        DisplayObjectContainer.prototype.cleanMask = function () {
            if (this._maskBitmap && _super.prototype.contains.call(this, this._maskBitmap)) {
                _super.prototype.removeChild.call(this, this._maskBitmap);
                this._maskBitmap = null;
            }
            if (!_super.prototype.contains.call(this, this._container)) {
                _super.prototype.addChild.call(this, this._container);
            }
        };
