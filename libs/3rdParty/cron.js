...
CronTime.prototype = {
  ...
  _getNextDateFrom: function(start) {
    ...
    if (this.realDate && start < Date.newDate())
  ...
  start: function() {
    ...
    function callbackWrapper() {
      ...
      if (remaining) {
        ...
        self._timeout = tm.setTimeout(callbackWrapper, timeout);
      } else {
    ...
    if (timeout >= 0) {
      ...
      this._timeout = tm.setTimeout(callbackWrapper, timeout);
    } else {
      this.stop();
		}
  },
