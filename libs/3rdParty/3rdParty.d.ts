...
declare module async {
     ...
     * @param ctx
     */
    function series(tasks: Array<(cb: (err?: any, arg?: any) => void) => void>, cb: (err: any, results: any[]) => void, ctx?: any): void;
    /**
     * 平行执行异步任务。
     * @param tasks
     * @param cb
     * @param ctx
     */
    function parallel(tasks: Array<(cb: (err?: any, arg?: any) => void) => void>, cb: (err: any, results: any[]) => void, ctx?: any): void;
    /**
     * 瀑布模式执行异步任务。
     * @param tasks
     * @param cb
     * @param ctx
     */
    function waterfall(tasks: Array<(...args: any[]) => void>, cb: (err: any, argFromLastTask?: any) => void, ctx?: any): void;
    /**
